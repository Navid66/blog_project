          ...
          <?php  while($postdata=mysqli_fetch_assoc($posts)){ ?>
               <tr>
                    ...
                    <td><?php if($postdata['post_status']==1){
                     ...
                     <td>
                        <a class="btn btn-primary" href="edit_post.php?
                        status=editpost&&id=<?php echo $postdata["post_id"]; ?>">Edit</a>
